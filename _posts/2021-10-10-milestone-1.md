...
<iframe id="igraph" scrolling="no" style="border:none;" seamless="seamless" src="https://dashapp-ift6758.herokuapp.com/" height="700" width="1000"></iframe>

## Q2

Ameture Commentator:
The "League Average Shot Count" map presents the total number of shots in a season  at all binned locations divded by the number of participated teams. This map provides insight on the most probable locations where a shot would be taken. While the majority of shots would be taken in front of the net, the map suggests that the left wing and ring wing players would take many shots from afar. The center player may have a tendency to take more shots when he is closer. Another observation is that the forward players would take a shoot immediately after reaching the offensive zone. For example, high shot concentration pockets can be observed in the 2019 season at coordinates (36,26),(36,0),(36,-26). 

The "Team Shot Count" map presents the total number of shots in a season at all binned locations made by a selected team. This map provides insight on the most probable locations where a shot would be taken by the selected team. The same general trend observed in the "League Average Shot Count" map can be seen here as well.

The "Shot Count Comparison" map is generated by taking the difference between the "League Average Shot Count" map from the "Team Shot Count" map. A possitive value in this map represents that the selected has made more shots at the location of interest than the league average and vice versa. This map can provide some insights on the team performance and the dominating strategy used by team.


Professional Hockey Analyst:
TBD

## Q3: Colorado Avalanche, 2016 vs. 2020

Ameture Commentator:
The 2016 comparison map shows that most of the shots made by the team was taken from afar or at an unfriendly angle. The 2020 comparison map shows that more shots are taken much closer and in front of the net. Based on the goal percentage graph created previously, a closer shot would have a higher probability of scoring. This suggests that the Colorado Avalanche is taking more shots at a more favourable postition. It is thus expected that the team would outperofming most teams in the 2020 season and that it is performing significantly better in the 2020 season than in the 2016 season.

Looking at the official team standings record, the Colorado Avalanche was indeed one of the top teams in the 2020 season and did not qualify for the playoff in the 2016 season.
...
Ameture Commentator:
The comparison map suggests that the majority of shots taken by the Tampa Bay Lightning are closer and in front of the net compare to the Buffalo Sabres in all three seasons.
However, although Tampa Bay Lightning is still a stronger team. The comparison maps would suggests that the Buffalo Sabres is improving since their shot counts are approaching the league average over the three seasons and the Tampa Bay Lighning is slwoly wekening.
