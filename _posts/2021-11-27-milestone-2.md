...
The Synthetic Minority Oversampling Technique (SMOTE) was employed to address the imbalanced dataset issue.


The model trained using this method was named  `xgboost-smote`

The SMOTE improved the performance of the logistic regression model.
vastly superior
